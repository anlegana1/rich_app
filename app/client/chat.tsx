            ...
            <View style={styles.avatarContainer}>
              <View style={styles.avatar}>
                <Text style={styles.avatarText}>
                  {chat.canchaName.substring(0, 2).toUpperCase()}
                </Text>
              </View>
              ...
              <View style={styles.chatHeader}>
                <View style={styles.avatarContainer}>
                  <View style={styles.modalAvatar}>
                    <Text style={styles.avatarText}>
                      {openChat.canchaName.substring(0, 2).toUpperCase()}
                    </Text>
                  </View>
                  {openChat.online && <View style={styles.onlineDot} />}
                </View>
                <View style={styles.chatInfo}>
                  <Text style={styles.modalChatName}>{openChat.canchaName}</Text>
                  <Text style={styles.chatStatus}>
                    {openChat.online ? '● En línea' : 'Desconectado'}
                  </Text>
                </View>
              </View>
            </View>
